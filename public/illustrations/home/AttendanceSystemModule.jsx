...
const AttendanceSystemModule = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 500" id="AttendanceSystemModule">
      ...
      {/* Title area */}
      <rect x="20" y="18" width="180" height="24" rx="6" fill="url(#attendance-primary-gradient)" opacity="0.9" />
      <text x="220" y="35" fontFamily="Arial" fontSize="14" fill="#1e293b">Attendance Management System</text>
      ...
      <g filter="url(#attendance-shadow)">
        ...
        <circle cx="530" cy="100" r="12" fill="#f1f5f9" />
        <circle cx="560" cy="100" r="12" fill="#f1f5f9" />
      </g>
      ...
      <g filter="url(#attendance-shadow)">
        ...
        <text x="95" y="245" fontFamily="Arial" fontSize="14" fill="#64748b">/ 37 students</text>
      ...
      <g filter="url(#attendance-shadow)">
        ...
        <text x="265" y="245" fontFamily="Arial" fontSize="14" fill="#64748b">/ 37 students</text>
      ...
      <g filter="url(#attendance-shadow)">
        ...
        <text x="460" y="245" fontFamily="Arial" fontSize="14" fill="#64748b">this week</text>
      ...
      <g filter="url(#attendance-shadow)">
        ...
        <text x="300" y="365" fontFamily="Arial" fontSize="14" fill="#64748b">CS22-1045</text>
        <rect x="420" y="352" width="70" height="24" rx="12" fill="#d1fae5" />
        <text x="455" y="367" fontFamily="Arial" fontWeight="bold" fontSize="12" fill="#10b981" textAnchor="middle">Present</text>
        <text x="520" y="365" fontFamily="Arial" fontSize="14" fill="#64748b">9:55 AM</text>
        ...
        <text x="300" y="405" fontFamily="Arial" fontSize="14" fill="#64748b">DS23-0872</text>
        <rect x="420" y="392" width="70" height="24" rx="12" fill="#d1fae5" />
        <text x="455" y="407" fontFamily="Arial" fontWeight="bold" fontSize="12" fill="#10b981" textAnchor="middle">Present</text>
        <text x="520" y="405" fontFamily="Arial" fontSize="14" fill="#64748b">9:58 AM</text>
        ...
        <text x="300" y="445" fontFamily="Arial" fontSize="14" fill="#64748b">CS22-1078</text>
        <rect x="420" y="432" width="70" height="24" rx="12" fill="#fee2e2" />
        <text x="455" y="447" fontFamily="Arial" fontWeight="bold" fontSize="12" fill="#ef4444" textAnchor="middle">Absent</text>
        <text x="520" y="445" fontFamily="Arial" fontSize="14" fill="#64748b">-</text>
        
        <line x1="40" y1="460" x2="560" y2="460" stroke="#e2e8f0" strokeWidth="1" />
      </g>
    </svg>
  );
};
